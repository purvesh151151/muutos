...
@section('pagetitle')
<h3 class="m-0 text-dark">{{ __('messages.vendor.edit') }}</h3>
@endsection
@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="card ">
            <div class="card-body">
                <form method="POST" action="{{ route('admin.vendor.update',$usersdata->id) }}"  enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $usersdata->company }}" name="company" class="form-control" maxlength="100" placeholder="Enter company" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
